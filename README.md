<div align="center">
    <picture>
    <source media="(prefers-color-scheme: dark)" srcset="assets/voice-logo-dark-bg.png">
    <source media="(prefers-color-scheme: light)" srcset="assets/voice-logo-light-bg.png">
    <img alt="Voice logo" src="assets/voice-logo-light-bg.svg" width="600">
    </picture>
...
- Results represent _indexed opinion_, not population-representative opinion
